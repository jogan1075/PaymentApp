...
fun SucessScreen(
    ...
    Box(
        ...
        Scaffold(topBar = {
            TopAppBar(
                title = { Text(text = stringResource(string.title_resume)) },
            ...
            Column {
                Row(
                    ...
                    Text(
                        text = stringResource(string.subtitle_resume),
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text = stringResource(string.resume_amount),
                        ...
                        Row(
                            ...
                            val tintColor =
                                if (MaterialTheme.colors.isLight) Color.Gray else Color.DarkGray
                        ...
                        Spacer(modifier = Modifier.padding(10.dp))
                        Text(
                            text = stringResource(string.resume_bank),
                            style = MaterialTheme.typography.h6.copy(fontSize = 14.sp),
                            modifier = Modifier
                                .padding(top = 10.dp),
                            color = Color.Black
                        ...
                        Spacer(modifier = Modifier.padding(10.dp))
                        Text(
                            text = stringResource(string.resume_quota),
                            style = MaterialTheme.typography.h6.copy(fontSize = 14.sp),
                            modifier = Modifier
                                .padding(top = 10.dp),
                            color = Color.Black
                        ...
                        Button(
                            ...
                            Text(
                                text = stringResource(string.btn_confirm),
                                color = white,
